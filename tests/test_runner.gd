...
func run_all() -> void:
	...
	preload("res://tests/unit/test_save_identity_recovery.gd").new().run(self)
	await preload("res://tests/unit/test_identity_recovery_gate.gd").new().run(self)
	await preload("res://tests/unit/test_host_saved_game.gd").new().run(self)
	...
	await preload("res://tests/unit/test_world_runtime.gd").new().run(self)
	await preload("res://tests/unit/test_environment_presentation.gd").new().run(self)
	...
	await preload("res://tests/unit/test_combat_runtime_replication.gd").new().run(self)
	await preload("res://tests/unit/test_combat_action_controller.gd").new().run(self)
	await preload("res://tests/unit/test_attack_timeline.gd").new().run(self)
	await preload("res://tests/unit/test_combat_hit_geometry.gd").new().run(self)
	await preload("res://tests/unit/test_player_hurt.gd").new().run(self)
	await preload("res://tests/unit/test_player_dodge.gd").new().run(self)
	await preload("res://tests/unit/test_attack_combo.gd").new().run(self)
	await preload("res://tests/unit/test_player_animation_presentation.gd").new().run(self)
	await preload("res://tests/unit/test_player_sprite_pipeline.gd").new().run(self)
	await preload("res://tests/unit/test_combat_runtime_state.gd").new().run(self)
	preload("res://tests/unit/test_multiplayer_quest_scope.gd").new().run(self)
	preload("res://tests/unit/test_multiplayer_settlement.gd").new().run(self)
	preload("res://tests/unit/test_multiplayer_player_items.gd").new().run(self)
