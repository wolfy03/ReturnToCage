...
func test_death_and_snapshot() -> void:
	...
	var result: RespawnResult = GameSession.handle_player_death(Vector2(810, 510))
	...
	t.assert_true(GameSession.handle_player_death(Vector2.ZERO) == result, "duplicate death returns original result")
	...
	var second: RespawnResult = GameSession.handle_player_death(Vector2(820, 510))
	...
	var home: RespawnResult = GameSession.handle_player_death(Vector2(200, 500))
...
func test_world_and_climbing() -> void:
	...
	var recovered_death: RespawnResult = GameSession.handle_player_death(death_position)
